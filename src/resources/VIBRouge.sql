...
insert into employee
    values(12345,'Elizabeth Martine');
...
insert into employee
    values(38847,'Ronny Stevens');

insert into employee
    values(73846,'Tiffany Lee');

insert into employee
    values(37485,'Timmy Lerr');

insert into employee
    values(73847,'Rihanna Depp');

insert into employee
    values(64536,'Arianna Lee');

insert into employee
    values(18273,'Leigh Smeenths');
